...
/** مراجع تست ۲ — خروجی graph.invoke (user_context.fifth) — content_output/context_output2.json */
const schemaAnalysisDataTest2: Record<string, SchemaAnalysisItem> = {
  ...
  'منفی‌نگری/بدبینی': {
    ...
    باور_بنیادین: 'اوضاع هرگز بهتر نخواهد شد و همسرم هیچ تغییری نخواهد کرد؛ آینده تاریک است.',
    تحلیل_بالینی:
...
const attachmentAnalysisDataTest2 = {
  ایمن: {
    نمره: 0,
    شواهد: [] as string[],
    تحلیل_بالینی: 'شاخص معناداری در متن یافت نشد'
  },
  'اضطرابی / دوسوگرا': {
    نمره: 8,
    شواهد: [
  ...
  'آشفته (ترسناک-اجتنابی)': {
    ...
    تحلیل_بالینی:
      'خشونت فیزیکی همسر، نوسان خشم و بی‌تفاوتی؛ دلبستگی آشفته با الگوی ترس-اجتنابی.'
  }
};
...
const cognitiveDistortionAnalysisDataTest2 = {
  distortions: {
    'All-or-Nothing Thinking': {
      ...
      summary: 'تفکر دوگانه: همه یا هیچ'
    },
    'Mind Reading': {
      score: 6,
      evidence: [
      ...
      summary: 'ذهن‌خوانی در مورد خواهر و شوهر'
    },
    'Negative Future Prediction': {
      score: 5,
      evidence: [
...
const relationalPatternAnalysisDataTest2 = {
  relational_pattern: {
    'Recurrent Conflict Pattern': {
      ...
      summary: 'الگوی تعارض مکرر با دعوا، قهر و سکوت'
    },
    'Unhealthy Dependence': {
      score: 6,
      evidence: [
      ...
      summary: 'وابستگی ناسالم به تغییر رفتار شوهر برای بهبود حال خود'
    },
    'Controlling Behavior': {
      score: 5,
      evidence: [
      ...
      summary: 'تلاش برای کنترل ارتباط شوهر با خواهرش'
    },
    'Pathological Jealousy': {
      ...
      summary: 'حساسیت شدید به تماس و ارتباط شوهر با خواهرش'
    }
  }
};

/** router این agent را برای مراجع تست ۲ انتخاب نکرد */
...
/** مراجع تست ۳ — خروجی graph.invoke (user_context.forth) — content_output/context_output3.json */
const schemaAnalysisDataTest3: Record<string, SchemaAnalysisItem> = {
  'جلب توجه / تأییدخواهی': {
    ...
    باور_بنیادین: 'برای احساس ارزشمندی باید دائماً از دیگران تأیید بگیرم و رضایت آنها را جلب کنم.',
    تحلیل_بالینی:
  ...
  'اطاعت': {
    ...
    باور_بنیادین: 'نیازها و خواسته‌های دیگران مهم‌تر از نیازهای من است و باید تسلیم خواسته‌های آنان شوم.',
    تحلیل_بالینی:
      'فرد نیازهای خود را نادیده می‌گیرد و مطابق خواسته‌های پارتنر رفتار می‌کند، حتی اگر منطقی نباشد.'
  },
  'نقص/شرم': {
    نمره: 90,
    شواهد: [
    ...
    باور_بنیادین: 'من معیوب، ناقص و بی‌ارزش هستم و دیگران این نقص را می‌بینند.',
    تحلیل_بالینی:
      'فرد نسبت به ظاهر و درآمد خود احساس حقارت و شرم دارد و خود را در مقایسه با دیگران ناکافی می‌بیند.'
  },
  'کنترل ضعیف / خودانضباطی': {
    نمره: 85,
    شواهد: [
      'بازم دارم جوی زندگی می کنم که به خودم آسیب می زنم',
      'بعضی وقتا وقتی دائم دارم این پولو براش خرج می کنم به خودم فوش می دم ... ولی بازم میرم انجامش میدم'
    ],
    باور_بنیادین: 'نمی‌توانم در برابر وسوسه‌ها و خواسته‌های لحظه‌ای مقاومت کنم، حتی اگر به خودم آسیب بزنم.',
    تحلیل_بالینی:
      'فرد علی‌رغم آگاهی از پیامدهای منفی قادر به کنترل رفتار خود نیست و به صورت تکانشی عمل می‌کند.'
  },
  'تنبیه‌گرایی': {
    نمره: 80,
    شواهد: [
    ...
    باور_بنیادین: 'من سزاوار تنبیه و سرزنش برای اشتباهاتم هستم و باید خود را مجازات کنم.',
    تحلیل_بالینی:
      'فرد پس از رفتارهای مخرب خود را سرزنش می‌کند و در رابطه قبلی نیز خود را مسئول شکست می‌داند.'
  }
};
...
const attachmentAnalysisDataTest3 = {
  ...
  'اضطرابی / دوسوگرا': {
    ...
    تحلیل_بالینی:
      'نیاز شدید به تأیید و توجه، مقایسه با دیگران، ترس از طرد و نشخوار رابطه قبلی با سرزنش خود.'
  },
  'اجتنابی / طردکننده': {
    نمره: 2,
    شواهد: ['می‌دانم که این رابطه موقته'],
    تحلیل_بالینی:
      'آگاهی از موقتی بودن رابطه نشانه‌ای از فاصله‌گیری شناختی است، اما اجتناب فعالانه وجود ندارد.'
  },
  'آشفته (ترسناک-اجتنابی)': {
    نمره: 8,
    شواهد: [
    ...
    تحلیل_بالینی:
      'رفتارهای متناقض و خودتخریب‌گرانه؛ احساس سردرگمی عاطفی و تکرار الگوهای ناکارآمد.'
  }
};
...
const cognitiveDistortionAnalysisDataTest3 = {
  distortions: {
    'Negative Future Prediction': {
      ...
      summary: 'پیش‌بینی منفی از آینده رابطه.'
    },
    'Mind Reading': {
      score: 6,
      evidence: [
      ...
      summary: 'ذهن‌خوانی در مورد نظرات و ترجیحات دیگران.'
    },
    Personalization: {
      score: 5,
      evidence: [
      ...
      summary: 'سرزنش خود برای اتفاقاتی که خارج از کنترل بوده.'
    }
  }
};
...
const relationalPatternAnalysisDataTest3 = {
  relational_pattern: {
    ...
    'Push-Pull / Rejection-Cling Cycle': {
      ...
      summary: 'چسبیدن به رابطه‌ای موقت و همزمان درگیر خاطرات رابطه قبلی بودن'
    }
  }
};
...
const functionalLevelAnalysisDataTest3 = {
  functional_level: {
    ...
    'Concentration / Attention Difficulties': {
      ...
      summary: 'مشکل در تمرکز و توجه به دلیل نشخوار فکری مداوم درباره رابطه قبلی'
    }
  }
};
